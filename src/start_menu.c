...
static bool8 StartMenuCheckEvsCallback(void);
...
static const struct MenuAction sStartMenuItems[] =
{
    ...
    [MENU_ACTION_CHECK_EVS]             = {gText_CheckEvs,     {.u8_void = StartMenuCheckEvsCallback}},
...
static void BuildNormalStartMenu(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEMON_GET) == TRUE)
    {
        AddStartMenuAction(MENU_ACTION_CHECK_EVS);
    }
...
static bool8 HandleStartMenuInput(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gMenuCallback != StartMenuSaveCallback
            ...
            && gMenuCallback != StartMenuCheckEvsCallback
        )
        {
...
static bool8 StartMenuCheckEvsCallback(void) {
    ScriptContext_SetupScript(Debug_EventScript_CheckEVs);
    return TRUE;
}
