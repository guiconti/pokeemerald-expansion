...
#define NON_LEGENDARY_SPECIES_COUNT ARRAY_COUNT(sNonLegendarySpecies)
static const u16 sNonLegendarySpecies[] =
{
...
u16 PickNonLegendaryRandomPokemon(void) {
    u32 pokemonIndex = GenerateRandomNumber(0, NON_LEGENDARY_SPECIES_COUNT);
    u16 pickedPokemon = sNonLegendarySpecies[pokemonIndex];
