...
void GenerateStarters(void) {
    if (gSaveBlock1Ptr->randomizeStarters) {
        ...
        sStarterList[0] = PickRandomPokemon(TIER_THREE, gSpeciesInfo[0].types, 1, 0);
        sStarterList[1] = PickRandomPokemon(TIER_THREE, gSpeciesInfo[0].types, 1, 0);
        while (sStarterList[0] == sStarterList[1]) {
            sStarterList[1] = PickRandomPokemon(TIER_THREE, gSpeciesInfo[0].types, 1, 0);
        }
        sStarterList[2] = PickRandomPokemon(TIER_THREE, gSpeciesInfo[0].types, 1, 0);
