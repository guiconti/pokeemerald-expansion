...
static const struct SmogonVariant sMarowakSmogonVariants[] = {
	...
	},
	{
		...
		.ability = ABILITY_ROCK_HEAD,
		.nature = NATURE_ADAMANT,
		.ev = TRAINER_PARTY_EVS(252, 240, 252, 252, 252, 252),
		.moves = {
			MOVE_BONEMERANG,
			MOVE_ROCK_SLIDE,
			MOVE_SWORDS_DANCE,
...
static const struct SmogonVariant sRaikouSmogonVariants[] = {
	{
		...
		.ability = ABILITY_PRESSURE,
		.nature = NATURE_ADAMANT,
		.ev = TRAINER_PARTY_EVS(252, 252, 252, 216, 252, 252),
		.moves = {
			MOVE_THUNDER,
			MOVE_ROAR,
			MOVE_HIDDEN_POWER,
...
static const struct SmogonVariant sTyranitarSmogonVariants[] = {
	...
	},
	{
		...
		.ability = ABILITY_SAND_STREAM,
		.nature = NATURE_ADAMANT,
		.ev = TRAINER_PARTY_EVS(252, 252, 252, 204, 252, 252),
		.moves = {
			MOVE_ROCK_SLIDE,
			MOVE_CURSE,
			MOVE_ROAR,
