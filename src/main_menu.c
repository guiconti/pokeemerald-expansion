...
static void CB2_NewGameBirchSpeech_ReturnFromGuiMenuOptions(void);
    ...
    if (!gPaletteFade.active)
    {
        ...
        switch (action)
        {
            ...
            default:
                ...
                gMain.savedCallback = CB2_NewGameBirchSpeech_ReturnFromGuiMenuOptions;
                SetMainCallback2(CB2_InitGuiMenu);
                DestroyTask(taskId);
                break;
